...
namespace Views
{
    public class DialogManager : IDialogManager
    {
        ...
        public DialogManager(IDialogProvider dialogProvider)
        {
        ...
        {
            var window = ((IClassicDesktopStyleApplicationLifetime) Application.Current.ApplicationLifetime).Windows.Last();            
            return window;
        }
    }
}